...
|:---:|:---|:---|:---|
| **R1** | **Concept Decoder** | `capabilities/product/concept-decoder.md` | **去模糊化**。使用 EARS 语法划定课题边界，确保研讨会讨论的是同一个东西。 |
| **R2** | **Market Hunter** | `capabilities/product/market-analyst.md` | **讲故事**。构建 User Story，论证市场痛点和差异化卖点。 |
| **R3** | **Tech Realist** | `capabilities/development/architect/tech-feasibility-auditor.md` | **算成本**。进行 Traceability Check，确保技术投入能带来业务产出。 |
| **R4** | **Logic Critic** | `capabilities/testing/logic-auditor.md` | **压力测试**。进行 Pre-mortem（事前尸检），检查商业守恒定律。 |
